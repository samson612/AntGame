 ...
 * @author cc483
 */
public class ChooseWorldFrame extends javax.swing.JFrame {
     ...
     */
    public ChooseWorldFrame(AntBrain[] listOfAntBrain) {
        this.listOfAntBrain = listOfAntBrain;
        initComponents();
    }

    private ChooseWorldFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChooseWorldFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChooseWorldFrame().setVisible(true);
            }
        });
    }
    ...
    class aTask extends SwingWorker<Void, Void>{
        private ChooseWorldFrame f;
        public aTask(ChooseWorldFrame f){
            this.f = f;
        }
        @Override
        public Void doInBackground() throws Exception {
            ...
            for(int i = 0; i < numberOfWorld; i++)
            {
                try {
                    ...
                    Logger.getLogger(ChooseWorldFrame.class.getName()).log(Level.SEVERE, null, ex);
                } 
